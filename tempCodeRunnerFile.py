...
class ResumeApp:
    ...
    "Upload your resume", type=[
        ...
        st.toast("Check out these repositories: [Awesome Java](https://github.com/YAMINI-IKI)", icon="ℹ️")
    ...
    def render_home(self):
        ...
        st.toast("Check out these repositories: [AI-Nexus(AI/ML)](https://github.com/YAMINI-IKI)", icon="ℹ️")
    ...
    def render_skill_gap(self):
        """Render the Skill Gap Analyzer page"""
        st.markdown("""
        ...
        # Job role selection with categories
        categories = {
        ...
        # Skill requirements for each role (expanded)
        role_skills = {
            "Python Developer": ["Python", "Git", "SQL", "Django/Flask", "REST APIs", "Docker", "Unit Testing", "Linux", "Data Structures", "Algorithms"],
            "Java Developer": ["Java", "Spring Boot", "SQL", "Git", "REST APIs", "Maven/Gradle", "Microservices", "Docker", "JUnit"],
            "Full Stack Developer": ["JavaScript", "React/Angular/Vue", "Node.js", "SQL", "MongoDB", "Git", "Docker", "REST APIs", "HTML/CSS"],
            "Frontend Developer": ["JavaScript", "React/Angular/Vue", "HTML", "CSS", "TypeScript", "Git", "Webpack", "Responsive Design"],
            "Backend Developer": ["Java/Python/Node.js", "SQL", "MongoDB", "REST APIs", "Microservices", "Docker", "Git", "Redis"],
            "Data Scientist": ["Python", "Pandas", "NumPy", "Scikit-learn", "SQL", "Data Visualization", "Statistics", "Machine Learning", "Deep Learning", "Tableau/PowerBI"],
            "Machine Learning Engineer": ["Python", "Machine Learning", "Deep Learning", "Scikit-learn", "TensorFlow/PyTorch", "SQL", "Docker", "Kubernetes", "MLOps", "AWS/GCP"],
            "AI Engineer": ["Python", "PyTorch/TensorFlow", "Transformers", "Deep Learning", "NLP", "Computer Vision", "SQL", "Docker", "AWS/GCP", "LLMs"],
            "Data Analyst": ["SQL", "Python/R", "Excel", "Data Visualization", "Tableau/PowerBI", "Statistics", "Business Intelligence"],
            "NLP Engineer": ["Python", "NLP", "Transformers", "PyTorch/TensorFlow", "LLMs", "Sentiment Analysis", "Name Entity Recognition"],
            "Cloud Engineer": ["AWS/Azure/GCP", "Docker", "Kubernetes", "Terraform", "Linux", "Python/Go", "Networking", "CI/CD"],
            "DevOps Engineer": ["Docker", "Kubernetes", "Jenkins/GitHub Actions", "AWS/Azure/GCP", "Terraform", "Linux", "Python/Shell", "Monitoring", "CI/CD"],
            "Site Reliability Engineer": ["Kubernetes", "Docker", "AWS/Azure/GCP", "Python/Go", "Prometheus", "Grafana", "Linux", "Incident Management"],
            "Platform Engineer": ["Kubernetes", "Docker", "AWS/Azure/GCP", "Terraform", "Python/Go", "CI/CD", "Service Mesh", "Monitoring"],
            "Security Engineer": ["Security Fundamentals", "Network Security", "OWASP", "Penetration Testing", "Security Auditing", "Python", "Linux"],
            "Penetration Tester": ["Penetration Testing", "OWASP", "Network Security", "Python", "Linux", "Metasploit", "Burp Suite", "Wireshark"],
            "Security Analyst": ["Security Fundamentals", "SIEM", "Incident Response", "Security Auditing", "Risk Assessment", "Python"],
            "SOC Analyst": ["SIEM", "Security Monitoring", "Incident Response", "Network Security", "Security Fundamentals"],
            "Android Developer": ["Java/Kotlin", "Android SDK", "Android Studio", "Git", "REST APIs", "Firebase", "Material Design"],
            "iOS Developer": ["Swift", "iOS SDK", "Xcode", "Git", "REST APIs", "Firebase", "Apple Design Guidelines"],
            "Flutter Developer": ["Flutter", "Dart", "Firebase", "REST APIs", "Git", "Mobile UI/UX"],
            "React Native Developer": ["React Native", "JavaScript", "Redux", "REST APIs", "Git", "Mobile UI/UX"],
            "Software Engineer": ["Data Structures", "Algorithms", "System Design", "Python/Java", "SQL", "Git", "Testing"],
            "Systems Engineer": ["C/C++", "Operating Systems", "Computer Architecture", "Linux", "Python/Shell", "Embedded Systems"],
            "Embedded Engineer": ["C/C++", "Embedded Systems", "Microcontrollers", "RTOS", "Python", "Hardware Design"],
            "QA Engineer": ["Testing Frameworks", "Selenium", "Python", "SQL", "Automation Testing", "Manual Testing", "CI/CD"]
        }

        # Recommended courses for skill gaps
        course_recommendations = {
            "Python": ["📚 Python for Everybody (Coursera)", "🎓 Python Data Science (edX)", "📖 Automate the Boring Stuff", "🎯 Real Python Tutorials"],
            "JavaScript": ["📚 JavaScript Essential Training (LinkedIn)", "🎓 Complete JavaScript (Udemy)", "📖 Eloquent JavaScript", "🎯 MDN Web Docs"],
            "React": ["📚 React Official Tutorial", "🎓 React Course (Scrimba)", "📖 Fullstack Open", "🎯 React Training"],
            "SQL": ["📚 SQL for Data Science (Coursera)", "🎓 Complete SQL (Udemy)", "📖 PostgreSQL Official Docs", "🎯 Mode Analytics SQL"],
            "Machine Learning": ["📚 Andrew Ng ML Course (Coursera)", "🎓 Fast.ai Practical DL", "📖 Hands-On ML", "🎯 Kaggle Learn"],
            "Deep Learning": ["📚 Deep Learning Specialization (Coursera)", "🎓 PyTorch Tutorials", "📖 Deep Learning Book", "🎯 Papers with Code"],
            "Docker": ["📚 Docker Mastery (Udemy)", "🎓 Docker Handbook", "📖 Docker Official Docs", "🎯 Play with Docker"],
            "Kubernetes": ["📚 CKAD Prep Course", "🎓 Kubernetes Handbook", "📖 Kubernetes Official Docs", "🎯 Minikube Tutorials"],
            "AWS": ["📚 AWS Certified Developer (Udemy)", "🎓 AWS Training", "📖 AWS Well-Architected", "🎯 AWS Hands-on Labs"],
            "Git": ["📚 Git Tutorial (Atlassian)", "🎓 Pro Git Book", "📖 Learn Git Branching", "🎯 GitHub Guides"]
        }

        # Get skills for selected role
        required_skills = role_skills.get(selected_role, [])

        # Display current skills input
        st.markdown("### 📝 Your Current Skills")
        st.markdown("Enter your existing skills (one per line)")
        ...
        if st.button("🔍 Analyze Skill Gap", type="primary", width='stretch'):
            ...
            with col1:
                st.markdown(f"""
                <div style='background: linear-gradient(135deg, #1a1a2e, #16213e); padding: 1.5rem; border-radius: 10px; text-align: center;'>
                    <h3 style='color: #4CAF50;'>📊 Match</h3>
                    <p style='color: white; font-size: 2rem; font-weight: bold;'>{match_percentage:.1f}%</p>
                    <p style='color: #a8a8a8;'>{len(matching_skills)}/{len(required_skills)} skills</p>
                </div>
                """, unsafe_allow_html=True)
            ...
            with col2:
                st.markdown(f"""
                <div style='background: linear-gradient(135deg, #1a1a2e, #16213e); padding: 1.5rem; border-radius: 10px; text-align: center;'>
                    <h3 style='color: #FFA500;'>✅ Matched</h3>
                    <p style='color: white; font-size: 2rem; font-weight: bold;'>{len(matching_skills)}</p>
                    <p style='color: #a8a8a8;'>skills found</p>
                </div>
                """, unsafe_allow_html=True)
            ...
            with col3:
                st.markdown(f"""
                <div style='background: linear-gradient(135deg, #1a1a2e, #16213e); padding: 1.5rem; border-radius: 10px; text-align: center;'>
                    <h3 style='color: #ff4444;'>❌ Missing</h3>
                    <p style='color: white; font-size: 2rem; font-weight: bold;'>{len(missing_skills)}</p>
                    <p style='color: #a8a8a8;'>skills to learn</p>
                </div>
                """, unsafe_allow_html=True)
            ...
            # Display missing skills with course recommendations
            if missing_skills:
                st.markdown("### 🎯 Skills You Need to Learn")
                st.markdown("Click on a skill to see learning resources")
                
                for skill in missing_skills:
                    with st.expander(f"📚 {skill}"):
                        # Get course recommendations for this skill
                        recommended_courses = []
                        for key, courses in course_recommendations.items():
                            if skill.lower() in key.lower() or any(skill.lower() in c.lower() for c in courses):
                                recommended_courses.extend(courses)
                                break
                        
                        if not recommended_courses:
                            # Provide default learning suggestions
                            recommended_courses = [
                                f"📚 Learn {skill} - Search online courses",
                                f"🎓 Practice {skill} - Build projects",
                                f"📖 Read documentation for {skill}",
                                f"🎯 Join communities for {skill} learners"
                            ]
                        ...
                        st.markdown("---")
                        st.markdown(f"💡 **Tip:** Try building a small project using {skill} to gain practical experience.")
            else:
                if matching_skills:
                    st.success("🎉 Great job! You have all the required skills for this role!")
            
            # Add a visual representation of the skill gap
            ...
            for skill in required_skills:
                has_skill = any(skill.lower() in cs.lower() or cs.lower() in skill.lower() for cs in current_skills)
                skill_data.append({
                    "Skill": skill,
                    "Status": "✅ Have" if has_skill else "❌ Need"
                })
            
            df = pd.DataFrame(skill_data)
            fig = px.bar(df, x="Status", color="Status", title="Skill Distribution",
                        color_discrete_map={"✅ Have": "#4CAF50", "❌ Need": "#ff4444"})
            ...
            if len(missing_skills) > 0:
                st.markdown(f"""
                <div style='background: linear-gradient(135deg, #1a1a2e, #16213e); padding: 1.5rem; border-radius: 10px;'>
                    <p style='color: white;'>Based on your skill gap analysis, we recommend focusing on these skills first:</p>
                    <ol style='color: #a8a8a8;'>
                """, unsafe_allow_html=True)
                
                for i, skill in enumerate(missing_skills[:5]):
                    st.markdown(f"<li style='margin-bottom: 8px;'><strong>{skill}</strong> - Start with beginner resources and build foundational knowledge</li>", unsafe_allow_html=True)
                
                if len(missing_skills) > 5:
                    st.markdown(f"<li style='margin-bottom: 8px;'>... and {len(missing_skills) - 5} more skills</li>", unsafe_allow_html=True)
                
                st.markdown("""
                    </ol>
                    <p style='color: #4CAF50;'>🚀 Start learning today and build your career!</p>
                </div>
                """, unsafe_allow_html=True)
    ...
    def render_feedback_page(self):
        ...
        st.toast("Check out these repositories: [TryHackMe Free Rooms](https://github.com/YAMINI-IKI)", icon="ℹ️")
...
<div style="background-color: #1e1e1e; border-radius: 10px; border: 1px solid #4b6cb7; padding: 10px; margin: 10px 0; color: white;">
    ...
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/YAMINI-IKI/tryhackme-free-rooms" target="_blank" style="color: #4CAF50;">TryHackMe Free Rooms</a></li>
    ...
    <ul style="margin-top: 0; padding-left: 20px;">
        ...
        <li><a href="https://github.com/YAMINI-IKI/30-Days-Of-Rust" target="_blank" style="color: #4CAF50;">30 Days Of Rust</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Data Structures & Algorithms:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/YAMINI-IKI/GeeksforGeeks-POTD" target="_blank" style="color: #4CAF50;">GeeksforGeeks POTD</a></li>
        <li><a href="https://github.com/YAMINI-IKI/Leetcode-POTD" target="_blank" style="color: #4CAF50;">Leetcode POTD</a></li>
    </ul>
